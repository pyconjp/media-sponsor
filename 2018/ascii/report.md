...
次に話をお聞きしたのは、フィンテック企業として、仮想通貨取引所であるZaifを開発しているテックビューロ株式会社の細井氏。元々個人開発していたプロダクトを買収し、それがPythonのフレームワークであるPyramidを利用していたことからPythonを利用するようになったそうです。
...
GROOVE X株式会社では、ロボット開発で、デザイナーの立場のメンバーがPythonを使ったプロトタイピングを行っているそうです。ペアプログラミングやモブプログラミングを導入して、エンジニア以外のメンバーも学びやすい環境を整えている等、組織づくりも工夫されていました。
...
メルカリではこの他にも「ディープラーニングのアーキテクチャ自体を自動である程度生成してしまおう」といった試みなども行っているそうです。最後に再び、GROOVE X株式会社の林さんに、「ロボット開発における機械学習」の話をお聞きしました。「機械学習を使って外界を認識できるのが最低条件」という話が印象的でした。
...
林氏　なかなか難しいんですが…。さっき「外界をきちんと認識できなければいけない」って言ったんですけど、最終的なアウトプットはロボット自身の行動だったりするので。人間も周りのことをよく分かっているようで、分かってなかったりもするじゃないですか。そういうところも含めて、人々の生活にちゃんと溶け込めるようなロボットを作りたいなと思っています。

## まとめ

いかがだったでしょうか？紙面の都合でお伝えできなかった話も多いのですが、当日の雰囲気は少しでも伝わっていれば嬉しいです。

各企業とも、それぞれの分野でPythonを活用されている様子をお聞きすることができました。自分の仕事と共通してる話や、逆に知らない分野の話もあったかと思います。それを通して、どこかの企業に興味を持ったり、今後のご自身の仕事に役立てられる話が提供できていればと思います。
...
![メルカリのブースは機械学習サービスの展示が豊富でした](./_static/mercari.jpg)
...
![GROOVE X株式会社のブースでは普段の仕事の様子を展示されていました](./_static/groovex.jpg)
...
![ノベルティを紹介する株式会社アイリッジのメンバー](./_static/iridge.jpg)
...
![自社の事業やメンバーが執筆した本を展示するSQUEEZEのブース](./_static/squeeze.jpg)
...
障害物検知などを行う技術に使っています。また、人の認知や判断を強化学習で実現させています。
