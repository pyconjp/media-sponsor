...
メルカリはC2C(Consumer to Consumer)という新しいマーケットで、累計出品数10億 × 累計ダウンロード数1億の大規模なデータを使った分析にチャレンジできるところが、他の会社に無い点だと思います。新しい種類・新しい規模のデータで、新しいサービスを作りたい方はぜひご応募ください。
...
Pythonエンジニアに向けたアンケートを行って、その結果をリアルタイムにグラフに反映させて展示しています。「去年と比べると、最初にPython3系から始めた人が増えてきているな」など分かって面白いんですよ。これに答えて頂けた方には「The Zen of Python」のステッカーを差し上げています。弊社のコーヒー好きな社員が監修した、アイリッジロゴが入ったコーヒー豆も配ってます。
...
弊社のメンバーが執筆した本を紹介しています。実はカンファレンスでもメンバーが2人発表しています。もちろんプロダクトも紹介しています。宿泊事業者様へのSaasでの運用サポートサービスの他、自社で開業したMinnという宿泊施設もあります。
