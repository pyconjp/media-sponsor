...
昨年から引き続いてスポンサー参加して頂いたGROOVE X 株式会社。「LOVE×ROBOT=LOVOT」というコンセプトで人に寄り添うロボットを開発中（2018年末発表予定）です。
...
　また、来場者のPythonistaにとっては、実際の会社での活用例や現場の雰囲気などをフランクに聞くことのできる機会脱兎のではないでしょうか。
