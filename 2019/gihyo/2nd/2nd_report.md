...
自分もそうですがデータ処理で困っているときは、タスクをワークフローで処理できるAirflowの発表を聞き直して活用していきたいです。
...
一般社団法人PyCon JPから商標権のお話がありました。「Python」を商標登録している会社に対し、米Pythonソフトウエア財団（PSF）として行動するとのことでした。
