...
[PyCon JP 2019](https://pycon.jp/2019/)は2019年9月14日のスプリント（HENNGE株式会社）、9月15日のチュートリアル、9月16日〜17日のカンファレンス(大田区産業プラザPiO)と4日間の会期で開催されました。来場者は4日間で約1160人と昨年を上回る大盛況で、Pythonへの注目が年々増していることがわかります。
...
「Python開発を円滑に進める」と聞いてどのようなイメージを持つでしょうか？Odagiri氏は、つまらないミスを減らすことと言います。
...
そこで、本セッションではDjangoでDDDを設計する際のやり方をDDDの用語を交えながら説明していました。
...
コード例や出力結果を用いた説明がわかりやすく、私もFEMを用いて解析したいと思える良い発表でした。また、プログラミングと合わせて、数学で求めることができるロジックについても勉強していきたいと思える発表でした。
...
2014年にあるOSSで、10億サイト(※1)のセキュリティが、燃え尽き寸前の1人のエンジニアの肩にかかっていたという事態が発生しました。
...
(※1)本レポートの公開時点では「1000万サイト」と表記していました。
イクバル氏から[「正しくは10億サイトだった」というコメント](https://twitter.com/iqbalabd/status/1186434153807376384?s=20)と[情報源の共有](https://twitter.com/iqbalabd/status/1186662855266820096?s=20)があり、「10億」に修正しました。
...
今回紹介しきれなかったものも含め、ライトニングトークの一覧はこちらです。また、PyCon JPの公式アカウントに[ライトニングトークの動画](https://www.youtube.com/watch?v=7U2D5tcMZb4)がアップロードされています。
